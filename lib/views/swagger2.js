  ...
  _.forEach(swagger.paths, function(api, path) {
    ...
    _.forEach(api, function(op, m) {
      ...
      var method = {
        ...
        isSecureHeaders: secureTypes.indexOf('headers') !== -1,
        parameters: [],
        headers: [],
      };
      ...
      if (method.isSecure && method.isSecureHeaders) {
        data.isSecureHeaders = method.isSecureHeaders
      }
      ...
      _.forEach(params, function(parameter) {
        ...
        // transform operation
        if (parameter.collectionFormat === 'pipes') {
