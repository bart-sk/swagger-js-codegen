    ...
    _.forEach(api, function (op, m) {
      ...
      _.forEach(params, function (parameter) {
        ...
        if (_.isString(parameter.$ref)) {
          ...
          if (!parameter && resolveSwaggerParameterRef(swagger, parameterRef)) {
            parameter = resolveSwaggerParameterRef(swagger, parameterRef);
          }
        }
 ...
 */
function resolveSwaggerParameterRef(swagger, ref) {
  ...
  if (ref.startsWith('#/paths/')) {
    ...
    if (
      ...
      Array.isArray(swagger.paths[decodedPath][method][paramType]) &&
      swagger.paths[decodedPath][method][paramType][paramIndex]
    ) {
      return swagger.paths[decodedPath][method][paramType][paramIndex];
    }
    return undefined;
  } else if (ref.startsWith('#/components/parameters/')) {
    // Standard OpenAPI 3 $ref to components.parameters
    var name = ref.split('/').pop();
    return swagger.components && swagger.components.parameters
      ? swagger.components.parameters[name]
      : undefined;
  }
  ...
  return swagger.components && swagger.components.parameters
    ? swagger.components.parameters[last]
    : undefined;
}
