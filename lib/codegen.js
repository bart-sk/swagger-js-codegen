...
var generateFromSwaggerJson = function (swaggerJson, opts) {
  ...
  if (opts.methods !== '*' && opts.methods !== '') {
    swagger = utilities.filterSwaggerPathsByMethods(swaggerJson, opts.methods);
  } else {
    swagger = utilities.filterSwaggerPathsByTags(swaggerJson, opts.tags);
  }
